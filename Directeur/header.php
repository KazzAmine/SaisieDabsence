        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="index.php" id="acceuil-menu" ><i class="fas fa-tachometer-alt"></i><span>Accueil</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="surveillance.php" id="sg-menu" ><i class="fas fa-table"></i><span>surveillance générale </span></a></li>
                    <li class="nav-item"><a class="nav-link" href="consultation-stgr.php"  id="stgr-menu" ><i class="fas fa-user-circle"></i><span>Stagiaire</span></a></li>
                </ul>
